...
forktest(void)
{
  ...
  3e:	43650513          	addi	a0,a0,1078 # 470 <settickets+0xa>
  ...
  68:	41c50513          	addi	a0,a0,1052 # 480 <settickets+0x1a>
  ...
  b8:	41c50513          	addi	a0,a0,1052 # 4d0 <settickets+0x6a>
  ...
  d4:	3d050513          	addi	a0,a0,976 # 4a0 <settickets+0x3a>
  ...
  ee:	3ce50513          	addi	a0,a0,974 # 4b8 <settickets+0x52>
